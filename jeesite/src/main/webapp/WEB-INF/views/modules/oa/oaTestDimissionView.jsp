...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/oa/oaTestDimission/form?id=${oaTestDimission.id}">离职表<shiro:hasPermission name="oa:oaTestDimission:edit">${not empty oaTestDimission.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaTestDimission:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
