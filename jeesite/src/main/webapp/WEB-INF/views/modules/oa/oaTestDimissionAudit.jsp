...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#"><shiro:hasPermission name="oa:oaTestDimission:edit">${oaTestDimission.act.taskName}</shiro:hasPermission><shiro:lacksPermission name="oa:oaTestDimission:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>

	<form:form id="inputForm" modelAttribute="oaTestDimission" action="${ctx}/oa/oaTestDimission/saveDimission" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<fieldset>
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:oaTestDimission:edit">
				<c:if test="${oaTestDimission.act.taskDefKey eq 'apply_end'}">
					<input id="btnSubmit" class="btn btn-primary" type="submit" value="兑 现" onclick="$('#flag').val('yes')"/>&nbsp;
				</c:if>

				<c:if test="${oaTestDimission.act.taskDefKey ne 'apply_end'}">
