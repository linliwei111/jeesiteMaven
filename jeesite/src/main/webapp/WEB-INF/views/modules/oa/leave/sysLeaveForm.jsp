...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/oa/leave/sysLeave/">离职申请表列表</a></li>
		<li class="active"><a href="${ctx}/oa/leave/sysLeave/form?id=${sysLeave.id}">离职申请表<shiro:hasPermission name="oa:leave:sysLeave:edit">${not empty sysLeave.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:leave:sysLeave:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysLeave" action="${ctx}/oa/leave/sysLeave/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:leave:sysLeave:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
