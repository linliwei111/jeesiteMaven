...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/sysLeave/">离职申请表列表</a></li>
		<shiro:hasPermission name="oa:sysLeave:edit"><li><a href="${ctx}/oa/sysLeave/form">离职申请表添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="sysLeave" action="${ctx}/oa/sysLeave/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>update_date</th>
				<th>remarks</th>
				<shiro:hasPermission name="oa:sysLeave:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="sysLeave">
			<tr>
				<td><a href="${ctx}/oa/sysLeave/form?id=${sysLeave.id}">
				...
				<shiro:hasPermission name="oa:sysLeave:edit"><td>
    				<a href="${ctx}/oa/sysLeave/form?id=${sysLeave.id}">修改</a>
					<a href="${ctx}/oa/sysLeave/delete?id=${sysLeave.id}" onclick="return confirmx('确认要删除该离职申请表吗？', this.href)">删除</a>
